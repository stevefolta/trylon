...
struct ClassInfo SmallStringBuilder__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 201, 3, Proto_(SmallStringBuilder__Standard), Proto_(Standard), Proto_(Object__Standard), nil, Sym_(SmallStringBuilder), nil, nil };

...
struct ClassInfo StringLiteral__Compiler__classInfo_ = 
	{ 89, 8, Proto_(StringLiteral__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(StringLiteral) ,nil };
...
obj_ index__StringLiteral__Compiler(obj_ this_)
{
	return Field_(index);
}


obj_ index_co___StringLiteral__Compiler(obj_ this_, obj_ value)
{
	Field_(index) = value;
	return value;
}
...
obj_ prepare_to_emit__StringLiteral__Compiler(obj_ this_)
{
...
obj_ value__StringLiteral__Compiler(obj_ this_)
{
	return Field_(value);
}


obj_ value_co___StringLiteral__Compiler(obj_ this_, obj_ value)
{
	Field_(value) = value;
	return value;
}

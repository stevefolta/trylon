...
struct ClassInfo ArgumentResult__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 200, 1, Proto_(ArgumentResult__X86Compiler), Proto_(X86Compiler), Proto_(Result__X86Compiler), nil, Sym_(ArgumentResult), nil, nil };

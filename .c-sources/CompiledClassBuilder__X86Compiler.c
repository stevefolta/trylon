...
struct ClassInfo CompiledClassBuilder__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 103, 3, Proto_(CompiledClassBuilder__X86Compiler), Proto_(X86Compiler), Proto_(ClassBuilder__X86Compiler), nil, Sym_(CompiledClassBuilder), nil, nil };

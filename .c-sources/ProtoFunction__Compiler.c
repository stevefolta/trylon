...
struct ClassInfo ProtoFunction__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 122, 1, Proto_(ProtoFunction__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(ProtoFunction), nil, nil };

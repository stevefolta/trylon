...
struct ClassInfo Iterator__ExpandoArray__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 186, 2, Proto_(Iterator__ExpandoArray__CCompiler), Proto_(ExpandoArray__CCompiler), Proto_(Object__Standard), nil, Sym_(Iterator), nil, nil };

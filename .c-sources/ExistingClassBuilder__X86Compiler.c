...
struct ClassInfo ExistingClassBuilder__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 100, 2, Proto_(ExistingClassBuilder__X86Compiler), Proto_(X86Compiler), Proto_(ClassBuilder__X86Compiler), nil, Sym_(ExistingClassBuilder), nil, nil };

...
struct ClassInfo ProtoExpression__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 164, 1, Proto_(ProtoExpression__CCompiler), Proto_(CCompiler), Proto_(TrylonExpression__Compiler), nil, Sym_(ProtoExpression), nil, nil };

...
struct ClassInfo StringBytesIterator__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 44, 3, Proto_(StringBytesIterator__Standard), Proto_(Standard), Proto_(Iterator__Standard), nil, Sym_(StringBytesIterator), nil, nil };

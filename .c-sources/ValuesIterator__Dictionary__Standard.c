...
struct ClassInfo ValuesIterator__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 73, 1, Proto_(ValuesIterator__Dictionary__Standard), Proto_(Dictionary__Standard), Proto_(Iterator__Dictionary__Standard), nil, Sym_(ValuesIterator), nil, nil };

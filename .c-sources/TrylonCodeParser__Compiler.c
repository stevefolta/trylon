...
struct ClassInfo TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 102, 5, Proto_(TrylonCodeParser__Compiler), Proto_(Compiler), Proto_(Object__Standard), nil, Sym_(TrylonCodeParser), nil, ((obj_) tu0_) };

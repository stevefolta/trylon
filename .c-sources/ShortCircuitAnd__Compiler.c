...
UsingSym_(ShortCircuitAnd)UsingClass_(Compiler)
UsingClass_(TrylonExpression__Compiler)
UsingClass_(ShortCircuitAnd__Compiler)
struct ClassInfo ShortCircuitAnd__Compiler__classInfo_ = 
	{ 97, 2, Proto_(ShortCircuitAnd__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(ShortCircuitAnd) ,nil };
...
obj_ create_co_with_co___ShortCircuitAnd__Compiler(obj_ this_, obj_ expr1, obj_ expr2)
{
	obj_ t0_;
...
obj_ emit_code_co___ShortCircuitAnd__Compiler(obj_ this_, obj_ builder)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ expr1__ShortCircuitAnd__Compiler(obj_ this_)
{
	return Field_(expr1);
}


obj_ expr1_co___ShortCircuitAnd__Compiler(obj_ this_, obj_ value)
{
	Field_(expr1) = value;
	return value;
}
...
obj_ expr2__ShortCircuitAnd__Compiler(obj_ this_)
{
	return Field_(expr2);
}


obj_ expr2_co___ShortCircuitAnd__Compiler(obj_ this_, obj_ value)
{
	Field_(expr2) = value;
	return value;
}
...
obj_ interpreted__ShortCircuitAnd__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
...
{
	UsingClass_(ShortCircuitAnd__Compiler)
	obj_ obj = AllocObj_(ShortCircuitAnd__Compiler);
	create_co_with_co___ShortCircuitAnd__Compiler(obj, expr1, expr2);
	return obj;
}


obj_ prepare_to_emit__ShortCircuitAnd__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;

...
struct ClassInfo SmallInt__CImplementation__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 38, 0, Proto_(SmallInt__CImplementation__Standard), Proto_(CImplementation__Standard), Proto_(Int__Standard), nil, Sym_(SmallInt), nil, nil };

...
struct ClassInfo ResultsNode__DictLiteral__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 186, 7, Proto_(ResultsNode__DictLiteral__Compiler), Proto_(DictLiteral__Compiler), Proto_(Object__Standard), nil, Sym_(ResultsNode), nil, nil };

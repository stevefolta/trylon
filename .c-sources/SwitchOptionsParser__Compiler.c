...
struct ClassInfo SwitchOptionsParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 192, 2, Proto_(SwitchOptionsParser__Compiler), Proto_(Compiler), Proto_(Object__Standard), nil, Sym_(SwitchOptionsParser), nil, nil };

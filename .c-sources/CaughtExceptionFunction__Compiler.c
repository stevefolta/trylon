...
struct ClassInfo CaughtExceptionFunction__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 143, 0, Proto_(CaughtExceptionFunction__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(CaughtExceptionFunction), nil, nil };

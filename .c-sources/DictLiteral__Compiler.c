...
struct ClassInfo DictLiteral__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 156, 4, Proto_(DictLiteral__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(DictLiteral), nil, ((obj_) tu0_) };

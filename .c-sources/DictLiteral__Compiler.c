...
obj_ dict__DictLiteral__Compiler(obj_ this_)
{
	return Field_(dict);
}


obj_ dict_co___DictLiteral__Compiler(obj_ this_, obj_ value)
{
	Field_(dict) = value;
	return value;
}
...
obj_ emit_code_co___DictLiteral__Compiler(obj_ this_, obj_ builder)
{
	...
	UsingClass_(LiteralResult__CCompiler)
		...
		t0_ = Call_(next_node_index_co_, this_, Int_(0));
		t0_ = Call_(dict, this_);
		t1_ = Call_(root, t0_);
...
obj_ index__DictLiteral__Compiler(obj_ this_)
{
	return Field_(index);
}


obj_ index_co___DictLiteral__Compiler(obj_ this_, obj_ value)
{
	Field_(index) = value;
	return value;
}
...
obj_ next_node_index__DictLiteral__Compiler(obj_ this_)
{
	return Field_(next_node_index);
}


obj_ next_node_index_co___DictLiteral__Compiler(obj_ this_, obj_ value)
{
	Field_(next_node_index) = value;
	return value;
}
...
obj_ results__DictLiteral__Compiler(obj_ this_)
{
	return Field_(results);
}


obj_ results_co___DictLiteral__Compiler(obj_ this_, obj_ value)
{

...
UsingSym_(ElseParser)UsingClass_(MethodParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(ElseParser__MethodParser__Compiler)
struct ClassInfo ElseParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 109, 0, Proto_(ElseParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(ElseParser), nil, nil };
...
obj_ create__ElseParser__MethodParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__ElseParser__MethodParser__Compiler(obj_ this_)
{
	UsingClass_(ElseParser__MethodParser__Compiler)
	obj_ obj = AllocObj_(ElseParser__MethodParser__Compiler);
	create__ElseParser__MethodParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___ElseParser__MethodParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{
	...
	UsingClass_(IfParser__MethodParser__Compiler)
		...
		if (t1_)
			...
			t0_ = new__IfParser__MethodParser__Compiler(Proto_(IfParser__MethodParser__Compiler));

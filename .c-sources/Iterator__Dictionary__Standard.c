...
struct ClassInfo Iterator__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 75, 1, Proto_(Iterator__Dictionary__Standard), Proto_(Dictionary__Standard), Proto_(Object__Standard), nil, Sym_(Iterator), nil, ((obj_) tu0_) };

...
struct ClassInfo BreakParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 112, 0, Proto_(BreakParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(BreakParser), nil, nil };

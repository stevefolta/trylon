...
struct ClassInfo StringUTF8Iterator__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 10, 4, Proto_(StringUTF8Iterator__Standard), Proto_(Standard), Proto_(Iterator__Standard), nil, Sym_(StringUTF8Iterator), nil, nil };

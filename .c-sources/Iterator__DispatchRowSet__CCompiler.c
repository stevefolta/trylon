...
struct ClassInfo Iterator__DispatchRowSet__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 166, 1, Proto_(Iterator__DispatchRowSet__CCompiler), Proto_(DispatchRowSet__CCompiler), Proto_(Object__Standard), nil, Sym_(Iterator), nil, nil };

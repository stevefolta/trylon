...
UsingSym_(TrylonExpressionParser)UsingClass_(Compiler)
UsingClass_(Object__Standard)
UsingClass_(TrylonExpressionParser__Compiler)
struct ClassInfo TrylonExpressionParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 202, 3, Proto_(TrylonExpressionParser__Compiler), Proto_(Compiler), Proto_(Object__Standard), nil, Sym_(TrylonExpressionParser), nil, nil };
...
obj_ create_co_line_co_context_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ context)
{
	obj_ t0_;
...
obj_ expression_expected_after_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ after)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ is_name_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ word)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ is_number_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ word)
{
	obj_ t0_;
	obj_ t1_;
	UsingInt_(48)
...
obj_ make_binop_call_co_with_co_and_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ name, obj_ object, obj_ argument)
{
...
obj_ new_co_line_co_context_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ context)
{
	UsingClass_(TrylonExpressionParser__Compiler)
	obj_ obj = AllocObj_(TrylonExpressionParser__Compiler);
	create_co_line_co_context_co___TrylonExpressionParser__Compiler(obj, words, line, context);
	return obj;
}


obj_ parse_additive_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_and_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_assignment_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new__List__Standard(obj_ this_);
	extern obj_ new_co_object_co_arguments_co___Send__Compiler(obj_ this_, obj_ name, obj_ object, obj_ arguments);
	obj_ t0_;
...
obj_ parse_declaration_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ lhs)
{
...
obj_ parse_equality_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
...
obj_ parse_error_co___TrylonExpressionParser__Compiler(obj_ this_, obj_ message)
{
...
obj_ parse_exclusive_or_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
...
obj_ parse_inclusive_or_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_keyword_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new__List__Standard(obj_ this_);
	extern obj_ new_co_object_co_arguments_co___Send__Compiler(obj_ this_, obj_ name, obj_ object, obj_ arguments);
	obj_ t0_;
...
obj_ parse_logical_and_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
...
obj_ parse_logical_or_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
...
obj_ parse_multiplicative_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_not_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
...
obj_ parse_postfix_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new_co_object_co_arguments_co___Send__Compiler(obj_ this_, obj_ name, obj_ object, obj_ arguments);
	extern obj_ new__List__Standard(obj_ this_);
	extern obj_ new__TupleExpression__Compiler(obj_ this_);
...
obj_ parse_primary_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new__List__Standard(obj_ this_);
	extern obj_ new_co_arguments_co_context_co___FunctionCall__Compiler(obj_ this_, obj_ name, obj_ arguments, obj_ context);
	...
	UsingMethod_(_nt__eq_) UsingMethod_(_pl_) UsingMethod_(_) UsingMethod_(_eq__eq_) UsingMethod_(append_co_) UsingMethod_(contains_co_) UsingMethod_(context) UsingMethod_(ends_with_co_) UsingMethod_(expression_expected_after_co_) UsingMethod_(first_character) UsingMethod_(is_done) UsingMethod_(is_number_co_) UsingMethod_(length) UsingMethod_(next) UsingMethod_(parse_error_co_) UsingMethod_(parse_expression) UsingMethod_(parse_inclusive_or_expression) UsingMethod_(parse_super_call) UsingMethod_(peek) UsingMethod_(starts_with_co_) UsingMethod_(substr_co_) UsingMethod_(substr_co_length_co_) UsingMethod_(words)
...
obj_ parse_relational_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_shift_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	obj_ t2_;
...
obj_ parse_super_call__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new__List__Standard(obj_ this_);
	...
	UsingClass_(SuperCall__Compiler)
		...
		if ((t0_) == nil) {
			t1_ = Call_(is_a_co_, on_proto, Proto_(ExistingProto__Compiler));
			t0_ = t1_;
			}
		t2_ = Not_(t0_);
		if (t2_)
...
obj_ parse_unary_expression__TrylonExpressionParser__Compiler(obj_ this_)
{
	extern obj_ new_co_object_co_arguments_co___Send__Compiler(obj_ this_, obj_ name, obj_ object, obj_ arguments);
	extern obj_ new__List__Standard(obj_ this_);
	obj_ t0_;

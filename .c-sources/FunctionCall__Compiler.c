...
struct ClassInfo FunctionCall__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 147, 4, Proto_(FunctionCall__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(FunctionCall), nil, nil };

...
struct ClassInfo KeyValuePairsIterator__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 42, 1, Proto_(KeyValuePairsIterator__Dictionary__Standard), Proto_(Dictionary__Standard), Proto_(Iterator__Dictionary__Standard), nil, Sym_(KeyValuePairsIterator), nil, ((obj_) tu0_) };

...
struct ClassInfo TryParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 124, 0, Proto_(TryParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(TryParser), nil, nil };

...
UsingSym_(WhileParser)UsingClass_(TrylonCodeParser__Compiler)
...
struct ClassInfo WhileParser__TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 116, 0, Proto_(WhileParser__TrylonCodeParser__Compiler), Proto_(TrylonCodeParser__Compiler), Proto_(Object__Standard), nil, Sym_(WhileParser), nil, nil };
...
obj_ create__WhileParser__TrylonCodeParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__WhileParser__TrylonCodeParser__Compiler(obj_ this_)
{
	UsingClass_(WhileParser__TrylonCodeParser__Compiler)
	obj_ obj = AllocObj_(WhileParser__TrylonCodeParser__Compiler);
	create__WhileParser__TrylonCodeParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___WhileParser__TrylonCodeParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

...
struct ClassInfo PepsiProto__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 81, 17, Proto_(PepsiProto__Compiler), Proto_(Compiler), Proto_(CompiledProto__Compiler), nil, Sym_(PepsiProto), nil, nil };
struct object PepsiProto__Compiler = 
	{ &PepsiProto__Compiler__classInfo_, {nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil} };

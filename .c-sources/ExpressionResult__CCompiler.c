...
struct ClassInfo ExpressionResult__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 195, 0, Proto_(ExpressionResult__CCompiler), Proto_(CCompiler), Proto_(Object__Standard), nil, Sym_(ExpressionResult), nil, nil };

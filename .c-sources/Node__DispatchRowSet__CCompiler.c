...
struct ClassInfo Node__DispatchRowSet__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 179, 4, Proto_(Node__DispatchRowSet__CCompiler), Proto_(DispatchRowSet__CCompiler), Proto_(Object__Standard), nil, Sym_(Node), nil, nil };

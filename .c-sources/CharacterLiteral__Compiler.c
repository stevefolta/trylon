...
struct ClassInfo CharacterLiteral__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 148, 2, Proto_(CharacterLiteral__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(CharacterLiteral), nil, nil };

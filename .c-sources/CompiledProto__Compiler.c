...
obj_ assign_field_indices__CompiledProto__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;
	UsingInt_(0)
...
obj_ newly_defined_functions__CompiledProto__Compiler(obj_ this_)
{
	obj_ t0_;
	obj_ t1_;

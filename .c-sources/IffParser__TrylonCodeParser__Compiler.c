...
UsingSym_(IffParser)UsingClass_(TrylonCodeParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(IffParser__TrylonCodeParser__Compiler)
struct ClassInfo IffParser__TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 97, 0, Proto_(IffParser__TrylonCodeParser__Compiler), Proto_(TrylonCodeParser__Compiler), Proto_(Object__Standard), nil, Sym_(IffParser), nil, nil };
...
obj_ create__IffParser__TrylonCodeParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__IffParser__TrylonCodeParser__Compiler(obj_ this_)
{
	UsingClass_(IffParser__TrylonCodeParser__Compiler)
	obj_ obj = AllocObj_(IffParser__TrylonCodeParser__Compiler);
	create__IffParser__TrylonCodeParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___IffParser__TrylonCodeParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

...
struct ClassInfo FileMissingException__File__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 45, 1, Proto_(FileMissingException__File__Standard), Proto_(File__Standard), Proto_(Exception__Standard), nil, Sym_(FileMissingException), nil, nil };

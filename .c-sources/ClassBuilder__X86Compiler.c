...
struct ClassInfo ClassBuilder__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 193, 2, Proto_(ClassBuilder__X86Compiler), Proto_(X86Compiler), Proto_(Object__Standard), nil, Sym_(ClassBuilder), nil, nil };
...
obj_ builder_for_co___ClassBuilder__X86Compiler(obj_ this_, obj_ class_context)
{
	...
	obj_ t0_;
	DefineString_(0, "Internal error: unknown type of ClassContext.")
	...
	UsingClass_(Standard)
		...
		builder = nil;
		t0_ = Call_(is_a_co_, class_context, Proto_(ExistingProto__Compiler));
		if (t0_)
			{
			...
			{
			t0_ = Call_(is_a_co_, class_context, Proto_(CompiledProto__Compiler));
			if (t0_)
				{

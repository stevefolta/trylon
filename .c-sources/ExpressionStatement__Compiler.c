...
struct ClassInfo ExpressionStatement__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 168, 2, Proto_(ExpressionStatement__Compiler), Proto_(Compiler), Proto_(Statement__Compiler), nil, Sym_(ExpressionStatement), nil, nil };

...
struct ClassInfo System__CImplementation__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 38, 0, Proto_(System__CImplementation__Standard), Proto_(CImplementation__Standard), Proto_(Object__Standard), nil, Sym_(System), nil, nil };

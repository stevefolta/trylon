...
struct ClassInfo IntLiteral__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 142, 2, Proto_(IntLiteral__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(IntLiteral), nil, nil };
...
obj_ resolve__IntLiteral__Compiler(obj_ this_)
{

...
struct ClassInfo CatchParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 106, 0, Proto_(CatchParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(CatchParser), nil, nil };

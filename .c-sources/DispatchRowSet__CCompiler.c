...
struct ClassInfo DispatchRowSet__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 186, 1, Proto_(DispatchRowSet__CCompiler), Proto_(CCompiler), Proto_(Object__Standard), nil, Sym_(DispatchRowSet), nil, ((obj_) tu0_) };

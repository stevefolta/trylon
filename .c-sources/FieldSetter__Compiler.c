...
struct ClassInfo FieldSetter__Compiler__classInfo_ = 
	{ 108, 2, Proto_(FieldSetter__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(FieldSetter) ,nil };
...
obj_ field__FieldSetter__Compiler(obj_ this_)
{
	return Field_(field);
}


obj_ field_co___FieldSetter__Compiler(obj_ this_, obj_ value)
{
	Field_(field) = value;
	return value;
}
...
obj_ on_proto__FieldSetter__Compiler(obj_ this_)
{
	return Field_(on_proto);
}


obj_ on_proto_co___FieldSetter__Compiler(obj_ this_, obj_ value)
{

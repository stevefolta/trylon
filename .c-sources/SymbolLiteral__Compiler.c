...
struct ClassInfo SymbolLiteral__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 145, 1, Proto_(SymbolLiteral__Compiler), Proto_(Compiler), Proto_(TrylonExpression__Compiler), nil, Sym_(SymbolLiteral), nil, nil };

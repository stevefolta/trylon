...
struct ClassInfo RemoveContext__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 47, 5, Proto_(RemoveContext__Dictionary__Standard), Proto_(Dictionary__Standard), Proto_(Object__Standard), nil, Sym_(RemoveContext), nil, nil };

...
struct ClassInfo ContinueParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 115, 0, Proto_(ContinueParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(ContinueParser), nil, nil };

...
struct ClassInfo NewSharedField__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 212, 2, Proto_(NewSharedField__X86Compiler), Proto_(X86Compiler), Proto_(Object__Standard), nil, Sym_(NewSharedField), nil, nil };

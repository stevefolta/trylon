...
struct ClassInfo NewSharedField__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 210, 2, Proto_(NewSharedField__X86Compiler), Proto_(X86Compiler), Proto_(Object__Standard), nil, Sym_(NewSharedField), nil, nil };

...
struct ClassInfo CommentParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 114, 0, Proto_(CommentParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(CommentParser), nil, nil };

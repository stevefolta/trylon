...
struct ClassInfo Iterator__ObjectMap__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 223, 1, Proto_(Iterator__ObjectMap__Standard), Proto_(ObjectMap__Standard), Proto_(Object__Standard), nil, Sym_(Iterator), nil, nil };

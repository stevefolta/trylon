...
struct ClassInfo LabelRef__MethodBuilder__X86Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 188, 2, Proto_(LabelRef__MethodBuilder__X86Compiler), Proto_(MethodBuilder__X86Compiler), Proto_(Object__Standard), nil, Sym_(LabelRef), nil, nil };

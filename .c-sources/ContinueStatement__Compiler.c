...
struct ClassInfo ContinueStatement__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 174, 1, Proto_(ContinueStatement__Compiler), Proto_(Compiler), Proto_(Statement__Compiler), nil, Sym_(ContinueStatement), nil, nil };

...
struct ClassInfo String__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 21, 2, Proto_(String__Standard), Proto_(Standard), Proto_(Object__Standard), nil, Sym_(String), nil, nil };
...
obj_ contains_co___String__Standard(obj_ this_, obj_ other)
{
	...
	UsingMethod_(_gt__eq_) UsingMethod_(index_of_string_co_)
		...
		t1_ = Call_(_gt__eq_, t0_, SmallInt_(0));
		return t1_;
		}
	return nil;
}
...
obj_ index_of_string_co___String__Standard(obj_ this_, obj_ search_string)
{
	...
	UsingInt_(1)
	UsingInt_(1)
	UsingMethod_(_) UsingMethod_(copy) UsingMethod_(is_empty) UsingMethod_(length) UsingMethod_(starts_with_co_) UsingMethod_(substr_co_) UsingMethod_(unary_minus)
...
obj_ index_of_co___String__Standard(obj_ this_, obj_ char_)
{
	...
	UsingInt_(1)
	UsingInt_(1)
	UsingMethod_(_pl_) UsingMethod_(_) UsingMethod_(_lt_) UsingMethod_(_eq__eq_) UsingMethod_(deref_char) UsingMethod_(start) UsingMethod_(stopper) UsingMethod_(unary_minus)

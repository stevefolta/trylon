...
struct ClassInfo DispatchTableEntry__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 221, 2, Proto_(DispatchTableEntry__CCompiler), Proto_(CCompiler), Proto_(Object__Standard), nil, Sym_(DispatchTableEntry), nil, nil };

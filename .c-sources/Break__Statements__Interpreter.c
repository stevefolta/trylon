...
struct ClassInfo Break__Statements__Interpreter__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 51, 0, Proto_(Break__Statements__Interpreter), Proto_(Statements__Interpreter), Proto_(Exception__Standard), nil, Sym_(Break), nil, nil };

...
UsingSym_(ForParser)UsingClass_(MethodParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(ForParser__MethodParser__Compiler)
struct ClassInfo ForParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 110, 0, Proto_(ForParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(ForParser), nil, nil };
...
obj_ create__ForParser__MethodParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__ForParser__MethodParser__Compiler(obj_ this_)
{
	UsingClass_(ForParser__MethodParser__Compiler)
	obj_ obj = AllocObj_(ForParser__MethodParser__Compiler);
	create__ForParser__MethodParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___ForParser__MethodParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{
	...
	UsingClass_(MethodParser__Compiler)
		...
		t2_ = Call_(context_co_, Proto_(MethodParser__Compiler), t1_);
		t0_ = Call_(context, Proto_(MethodParser__Compiler));

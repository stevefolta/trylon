...
UsingSym_(IfParser)UsingClass_(TrylonCodeParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(IfParser__TrylonCodeParser__Compiler)
struct ClassInfo IfParser__TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 109, 0, Proto_(IfParser__TrylonCodeParser__Compiler), Proto_(TrylonCodeParser__Compiler), Proto_(Object__Standard), nil, Sym_(IfParser), nil, nil };
...
obj_ create__IfParser__TrylonCodeParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__IfParser__TrylonCodeParser__Compiler(obj_ this_)
{
	UsingClass_(IfParser__TrylonCodeParser__Compiler)
	obj_ obj = AllocObj_(IfParser__TrylonCodeParser__Compiler);
	create__IfParser__TrylonCodeParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___IfParser__TrylonCodeParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

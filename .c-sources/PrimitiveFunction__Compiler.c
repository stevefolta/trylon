...
struct ClassInfo PrimitiveFunction__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 128, 2, Proto_(PrimitiveFunction__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(PrimitiveFunction), nil, nil };

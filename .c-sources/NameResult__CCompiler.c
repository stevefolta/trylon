...
struct ClassInfo NameResult__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 207, 2, Proto_(NameResult__CCompiler), Proto_(CCompiler), Proto_(ExpressionResult__CCompiler), nil, Sym_(NameResult), nil, nil };

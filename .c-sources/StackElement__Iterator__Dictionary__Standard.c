...
struct ClassInfo StackElement__Iterator__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 76, 2, Proto_(StackElement__Iterator__Dictionary__Standard), Proto_(Iterator__Dictionary__Standard), Proto_(Object__Standard), nil, Sym_(StackElement), nil, nil };

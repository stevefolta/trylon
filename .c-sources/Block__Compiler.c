...
struct ClassInfo Block__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 102, 3, Proto_(Block__Compiler), Proto_(Compiler), Proto_(Context__Compiler), nil, Sym_(Block), nil, nil };
...
obj_ lookup_function_autodeclaring_co___Block__Compiler(obj_ this_, obj_ name)
{
	...
	UsingInt_(1)
	DefineString_(0, ":")
	UsingMethod_(_) UsingMethod_(add_local_co_) UsingMethod_(ends_with_co_) UsingMethod_(length) UsingMethod_(lookup_function_co_) UsingMethod_(substr_co_length_co_)

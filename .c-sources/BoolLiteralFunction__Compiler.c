...
struct ClassInfo BoolLiteralFunction__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 129, 1, Proto_(BoolLiteralFunction__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(BoolLiteralFunction), nil, nil };

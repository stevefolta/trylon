...
struct ClassInfo IndexedResources__CCompiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 219, 2, Proto_(IndexedResources__CCompiler), Proto_(CCompiler), Proto_(Object__Standard), nil, Sym_(IndexedResources), nil, nil };

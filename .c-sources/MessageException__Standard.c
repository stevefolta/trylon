...
struct ClassInfo MessageException__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 22, 1, Proto_(MessageException__Standard), Proto_(Standard), Proto_(Exception__Standard), nil, Sym_(MessageException), nil, nil };

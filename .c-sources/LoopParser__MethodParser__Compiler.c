...
UsingSym_(LoopParser)UsingClass_(MethodParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(LoopParser__MethodParser__Compiler)
struct ClassInfo LoopParser__MethodParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 113, 0, Proto_(LoopParser__MethodParser__Compiler), Proto_(MethodParser__Compiler), Proto_(Object__Standard), nil, Sym_(LoopParser), nil, nil };
...
obj_ create__LoopParser__MethodParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__LoopParser__MethodParser__Compiler(obj_ this_)
{
	UsingClass_(LoopParser__MethodParser__Compiler)
	obj_ obj = AllocObj_(LoopParser__MethodParser__Compiler);
	create__LoopParser__MethodParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___LoopParser__MethodParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

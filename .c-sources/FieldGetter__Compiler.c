...
struct ClassInfo FieldGetter__Compiler__classInfo_ = 
	{ 105, 8, Proto_(FieldGetter__Compiler), Proto_(Compiler), Proto_(TrylonFunction__Compiler), nil, Sym_(FieldGetter) ,nil };
...
obj_ field__FieldGetter__Compiler(obj_ this_)
{
	return Field_(field);
}


obj_ field_co___FieldGetter__Compiler(obj_ this_, obj_ value)
{
	Field_(field) = value;
	return value;
}
...
obj_ on_proto__FieldGetter__Compiler(obj_ this_)
{
	return Field_(on_proto);
}


obj_ on_proto_co___FieldGetter__Compiler(obj_ this_, obj_ value)
{

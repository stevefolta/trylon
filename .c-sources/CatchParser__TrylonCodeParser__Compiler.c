...
UsingSym_(CatchParser)UsingClass_(TrylonCodeParser__Compiler)
UsingClass_(Object__Standard)
UsingClass_(CatchParser__TrylonCodeParser__Compiler)
struct ClassInfo CatchParser__TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 104, 0, Proto_(CatchParser__TrylonCodeParser__Compiler), Proto_(TrylonCodeParser__Compiler), Proto_(Object__Standard), nil, Sym_(CatchParser), nil, nil };
struct object CatchParser__TrylonCodeParser__Compiler = 
	{ &CatchParser__TrylonCodeParser__Compiler__classInfo_, {} };




obj_ create__CatchParser__TrylonCodeParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__CatchParser__TrylonCodeParser__Compiler(obj_ this_)
{
	UsingClass_(CatchParser__TrylonCodeParser__Compiler)
	obj_ obj = AllocObj_(CatchParser__TrylonCodeParser__Compiler);
	create__CatchParser__TrylonCodeParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___CatchParser__TrylonCodeParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

...
struct ClassInfo TrylonProtoParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 190, 5, Proto_(TrylonProtoParser__Compiler), Proto_(Compiler), Proto_(Object__Standard), nil, Sym_(TrylonProtoParser), nil, nil };

...
struct ClassInfo PrimitiveObject__Interpreter__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 163, 1, Proto_(PrimitiveObject__Interpreter), Proto_(Interpreter), Proto_(TrylonExpression__Compiler), nil, Sym_(PrimitiveObject), nil, nil };

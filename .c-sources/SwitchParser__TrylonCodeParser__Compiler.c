...
UsingSym_(SwitchParser)UsingClass_(TrylonCodeParser__Compiler)
...
struct ClassInfo SwitchParser__TrylonCodeParser__Compiler__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 113, 0, Proto_(SwitchParser__TrylonCodeParser__Compiler), Proto_(TrylonCodeParser__Compiler), Proto_(Object__Standard), nil, Sym_(SwitchParser), nil, nil };
...
obj_ create__SwitchParser__TrylonCodeParser__Compiler(obj_ this_)
{
	return nil;
}


obj_ new__SwitchParser__TrylonCodeParser__Compiler(obj_ this_)
{
	UsingClass_(SwitchParser__TrylonCodeParser__Compiler)
	obj_ obj = AllocObj_(SwitchParser__TrylonCodeParser__Compiler);
	create__SwitchParser__TrylonCodeParser__Compiler(obj);
	return obj;
}


obj_ parse_co_line_co_parser_co___SwitchParser__TrylonCodeParser__Compiler(obj_ this_, obj_ words, obj_ line, obj_ parser)
{

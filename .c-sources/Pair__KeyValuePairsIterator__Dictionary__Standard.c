...
struct ClassInfo Pair__KeyValuePairsIterator__Dictionary__Standard__classInfo_ = 
	{ StdClassRef_(Class__CImplementation), 77, 2, Proto_(Pair__KeyValuePairsIterator__Dictionary__Standard), Proto_(KeyValuePairsIterator__Dictionary__Standard), Proto_(Object__Standard), nil, Sym_(Pair), nil, nil };
